 ...
 */
class EloquentSearchJobSeekerRepository {

    public function getJobsSeekersPaginated(Request $request,$query, $per_page, $order_by ='users.created_at', $sort = 'desc') {
        ...
        $paginator = $this->getJobSeekerPaginator($request, $candidate_info, $per_page);
