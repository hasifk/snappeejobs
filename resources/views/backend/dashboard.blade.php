        ...
        <div id="carousel-example-generic" class="carousel slide" data-ride="carousel">
            ...
            <div class="carousel-inner" role="listbox">
                <div class="item active">
                    <img src="https://upload.wikimedia.org/wikipedia/commons/6/67/Inside_the_Batad_rice_terraces.jpg" alt="visitors">
                    <div class="carousel-caption">
                        Total Visitors for Company: {{$visitors}}
                    </div>
                </div>
                <div class="item">
                    <img src="http://science-all.com/images/landscape/landscape-04.jpg" alt="Jobs">
                    <div class="carousel-caption">
                        Total Active Job Openings:{{$active_job_listings1}}
                    </div>
                </div>
                <div class="item">
                    <img src="http://media1.santabanta.com/full1/Outdoors/Landscapes/landscapes-267a.jpg" alt="Likes">
                    <div class="carousel-caption">
                        Total Likes for Company:{{$thumbs_ups}}
                    </div>
                </div>
