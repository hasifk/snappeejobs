...
class CustomTableSeeder extends \Illuminate\Database\Seeder
{
    ...
    public function run(){
        ...
        \DB::statement(
            "
            INSERT INTO `users` (`id`, `name`, `email`, `password`, `status`, `confirmation_code`, `confirmed`, `remember_token`, `avatar_filename`, `avatar_extension`, `avatar_path`, `about_me`, `country_id`, `state_id`, `dob`, `gender`, `no_password`, `employer_id`, `created_at`, `updated_at`, `deleted_at`, `stripe_active`, `stripe_id`, `stripe_subscription`, `stripe_plan`, `last_four`, `trial_ends_at`, `subscription_ends_at`) VALUES
            (6, 'Employer 1', 'employer1@gmail.com', '$2y$10$uSIinViohancWj52hu.msOWTQ9oMjI85qHJ5G4JG/GPQN2piS.IXq', 1, '08b0e03775b306dcf43434dc7eaad42f', 1, 'shsltrEh32bW7PrJIYdjkJpZsP9v0ZDBIfEPBp3tWESBmvmEznsWBMyedlMo', '', '', '', '', 1, 1, '0000-00-00', '', 1, 6, '2016-03-07 03:08:35', '2016-03-07 03:18:52', NULL, 1, 'cus_82OlaTABFNAM3s', 'sub_82OlR9gPkqN4g2', 'snappeejobs1', '4242', NULL, NULL),
