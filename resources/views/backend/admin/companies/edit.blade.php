...
@section('page-header')
    <h1>
        Edit Company Profile {{ $company->title }}
    </h1>
@endsection
...
@section('content')
    ...
    <form method="POST" action="{{ route('admin.company.update', $company->id) }}" accept-charset="UTF-8" class="form-horizontal" role="form" enctype="multipart/form-data">
